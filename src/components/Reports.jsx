...
export default function Reports({ products = [] }) {
  return (
    <div>
      <h2 className="text-3xl font-bold mb-9 mt-16">Sales</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="card">
          ...
          <div className="mt-3">
            <button onClick={() => exportToCSV('inventory-report.csv', products)} className="bg-green-600 hover:bg-green-700 text-white font-semibold px-4 py-2 rounded transition">Download CSV</button>
          </div>
        </div>
        <div className="card">
